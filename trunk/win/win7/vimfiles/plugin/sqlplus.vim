...
"" 05-09-2013 ## GVIM74 Mapping key crash when Load Awk/Perl support - change 's*' to 'sq*'##
...
"" 05-09-2013 ## GVIM74 Mapping key crash when Load Awk/Perl support - change 's*' to '*s*'##
map <Leader>bsb   :call AE_openEmptySqlBuffer()<CR>
map <Leader>sss   "zyy:call AE_execLiteralQuery( @z )<CR>
map <Leader>ese   :call AE_execQueryUnderCursor()<CR>
map <Leader>tst   :call AE_describeTableUnderCursor()<CR>
exe "map <Leader>csc   :call AE_openSqlBuffer( \"" . g:sqlplus_common_buffer . "\" )<CR>"

map <C-F7>  :call AE_execWholeScript()<CR>
map <C-F8>  :call AE_execQueryUnderCursor()<CR>
map <Leader><C-F8> :call AE_promptQuery()<CR>
map <C-F9>  :call AE_describeTableUnderCursor()<CR>
map <C-F10> :call AE_describeTablePrompt()<CR>
map <C-F11> :call AE_getSQLPlusUIDandPasswd(1)<CR>
"}}}
